...
const modules = [
  { address: process.env.VITE_MODULE_PUBLISHER_ACCOUNT_ADDRESS, name: "message_board" },
  { address: process.env.VITE_MODULE_PUBLISHER_ACCOUNT_ADDRESS, name: "gamified_learning" },
  { address: process.env.VITE_MODULE_PUBLISHER_ACCOUNT_ADDRESS, name: "quiz_rewards" },
